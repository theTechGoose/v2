...
export const STRINGS: Record<Lang, Strings> = {
  en: {
    ...
    "marquee.items":
      "Quotes · Contracts · Invoices · Reminders · Payments · Reviews",
    "problems.eyebrow": "The problem",
    "problems.title": "Three things that kill small contractors",
    "problems.cards": [
      {
        t: "Slow quotes",
        d: "Estimates take days to write up. Clients move on.",
      },
      {
        t: "Vague contracts",
        d: "Job-detail creep eats your margin and your weekends.",
      },
      {
        t: "Late invoices",
        d: "Sent too late or never sent at all. Cash gets squeezed.",
      },
    ],
    ...
    "features.items": [
      {
        t: "Bilingual SMS",
        d: "EN/ES out of the box. Texts that sound like you.",
      },
      {
        t: "Auto reminders",
        d: "Polite nudges until they pay. No awkward calls.",
      },
    ...
    "footer.tagline":
      "Paperwork Monster — built for contractors who'd rather be on the truck.",
  ...
  es: {
    ...
    "marquee.items":
      "Cotizaciones · Contratos · Facturas · Recordatorios · Pagos · Reseñas",
    "problems.eyebrow": "El problema",
    "problems.title": "Tres cosas que hunden a los contratistas",
    "problems.cards": [
      {
        t: "Cotizaciones lentas",
        d: "Tardas días en mandar el estimado. El cliente se va.",
      },
      {
        t: "Contratos vagos",
        d: "El alcance crece y se come tu margen y tus fines de semana.",
      },
      {
        t: "Facturas tarde",
        d: "Llegan tarde o nunca. El flujo de caja se ahoga.",
      },
    ],
    ...
    "features.items": [
      { t: "SMS bilingüe", d: "Inglés/Español sin configurar nada." },
      {
        ...
        d: "Empujones amables hasta que pagan.",
      },
    ...
    "contact.placeholder": "(512) 555-1234",
    "footer.tagline":
      "Paperwork Monster — para los contratistas que prefieren estar en obra.",
