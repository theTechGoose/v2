...
export const STRINGS: Record<Lang, Strings> = {
  en: {
    ...
    "footer.tagline": "Paperwork Monsters — built for contractors who'd rather be on the truck.",
  ...
  es: {
    ...
    "contact.placeholder": "(512) 555-1234",
    "footer.tagline": "Paperwork Monsters — para los contratistas que prefieren estar en obra.",
