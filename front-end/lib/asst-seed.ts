    ...
    items: [
      {
        ...
        client: "Tom & Linda K.",
        preview:
          "Garage epoxy floor — 2-car, includes prep, primer, and topcoat. Awaiting signature.",
        time: "8m",
        chip: "sent",
        chipLabel: "Sent",
        active: true,
      },
      {
        ...
        client: "Marcus Lin",
        preview:
          '"Need a quote for kitchen backsplash, ~30 sqft, white subway tile."',
        time: "1h",
        chip: "draft",
        chipLabel: "Drafted",
      },
      {
        ...
        preview:
          "Followed up on overdue invoice #INV-204 ($1,160) — payment promised by Friday.",
        time: "3h",
        chip: "needs",
        chipLabel: "Nudged",
      },
    ...
    items: [
      {
        ...
        client: "Sarah Chen",
        preview:
          "Bathroom remodel contract drafted and e-signed. Crew scheduled Wed.",
        time: "Mon",
        chip: "paid",
        chipLabel: "Signed",
      },
    ...
    items: [
      {
        ...
        preview:
          "Patio re-tile invoice #INV-198 sent. $1,000 deposit received.",
        time: "Sun",
        chip: "paid",
        chipLabel: "Paid",
      },
