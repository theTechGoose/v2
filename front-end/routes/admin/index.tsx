...
import AdminPage from "../../islands/AdminPage.tsx";
...
export default define.page(function AdminRoute(ctx) {
  ...
  return (
    <>
      <Head>
        <title>Admin · {tFor(lang, "brand.name")}</title>
        <link rel="stylesheet" href="/dashboard.css" />
      </Head>
      <div class="app">
        <DashSidebar active="admin" />
        <main class="main">
