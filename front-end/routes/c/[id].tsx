      ...
      >
        ...
        <div class="ctr__inner" style="padding:36px 44px 40px">
          ...
          <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:16px;flex-wrap:wrap">
            <div>
              <span
                style={`display:inline-block;background:rgba(255,107,107,0.10);color:${PINK_DARK};font-size:11px;font-weight:800;letter-spacing:.18em;text-transform:uppercase;padding:6px 12px;border-radius:999px`}
              >
            ...
            <section style="margin-top:36px">
              ...
              <div style="margin-top:18px;display:grid;grid-template-columns:1fr 1fr;gap:18px;align-items:stretch">
                ...
                {signed
                  ...
                  : (
                    <div
                      style={`padding:14px 16px;background:rgba(255,107,107,0.06);border:1px dashed rgba(255,107,107,0.45);border-radius:12px;min-height:96px;display:flex;flex-direction:column;justify-content:flex-end`}
                    >
                      <div
                        style={`font-size:10px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:${PINK_DARK}`}
                      >
                        {t.yourSignature}
                      </div>
                      <div
                        style={`margin-top:6px;font-size:13px;color:${MUTED}`}
                      >
                        {t.signTypeBelow}
                      </div>
                    </div>
