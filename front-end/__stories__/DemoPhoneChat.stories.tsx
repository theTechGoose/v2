...
function PhoneStyles() {
  return (
    <style
      // Static stylesheet import (no user input).
...
const FRAME =
  "padding: 24px; background: var(--mint-100, #f6f8f5); min-height: 100vh; display: grid; place-items: center;";
