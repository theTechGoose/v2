...
export const CONTRACT_TERMS_WIZARD_V1: WizardSpec = {
  ...
  steps: [
    ...
    },
    {
      ...
      options: [
        { id: "net_15",     label: "Get paid on completion", sub: "Same-day payment" },
        { id: "50_50",      label: "50/50",                  sub: "Half upfront, half when done" },
        { id: "30_30_40",   label: "30/30/40",               sub: "Start, halfway, done" },
        { id: "deposit_bal",label: "Deposit + balance",      sub: "Small upfront, rest when done" },
        { id: "custom",     label: "Custom",                 sub: "Set your own terms", isCustom: true },
      ],
    },
    {
      id: "warranty",
